...
<p align="center"><a href="https://simon-starport.netlify.app/">在线示例</a></p>
...
我们很常会在在不同的路由（页面）上使用统一组件，但他们的位置和大小可以不尽相同。这时你可能会希望在用户进行路由跳转时，想让它们展示流畅的过渡动画。尽管这样的动画在原生应用中较为常见，但要在 Web 中实现却有一些挑战。
...
感谢 [@hangsman](https://github.com/hangsman)，他帮助提供了使用 `<Teleport>` 的最初解决方案，从而让这个想法得以实装。也感谢 [我在 Bilibli 的直播](https://space.bilibili.com/668380)观众，与我一起研究这个想法并在直播期间提供了许多宝贵的反馈。
